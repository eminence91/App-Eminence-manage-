...
import {
  ...
  Filter, ChevronRight, Shield, ShieldOff
} from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted">{mockCollaborateurs.length} collaborateurs enregistrés</p>
          </div>
        </div>
        <button
          onClick={() => router.push('/collaborateurs/nouveau')}
